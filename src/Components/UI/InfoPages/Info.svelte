<div>
    ...
    <p>
        A landscape generator made for TYI 2022-2023.
        It implements detailed generation parameters, 2D and 3D visualization, exporting, importing & other operations with maps, saving and opening the project etc.
    </p>
    <p>
        The source code is available on <a target="_blank" href="https://github.com/egor-vaskon/LGTYI">GitHub</a>.
    </p>
    <p><a target="_blank" href="instruction/index.html">Help</a>
    ...
    <p>
        <a target="_blank" href="https://icons8.com/icon/39815/go-back">Go Back</a>,
